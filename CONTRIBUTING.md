# Contributing to Kryten Playlist

Thank you for considering contributing to Kryten Playlist! This document provides guidelines for contributing to the project.
...
1. Clone your fork:
```bash
git clone https://github.com/YOUR_USERNAME/kryten-playlist.git
cd kryten-playlist
```
...
# Type checking
poetry run mypy kryten_playlist
```
...
```bash
poetry run pytest --cov=kryten_playlist --cov-report=term-missing
```
